...
export default function HeroCarousel() {
  ...
  useEffect(() => {
    ...
    if (el) {
      ...
      el.style.animation = 'kenburns 5.5s ease-out forwards'
    }
  }, [current])
      ...
      {SLIDES.map((slide, i) => (
        ...
        >
          <div
            ...
            style={i === 0 ? { animation: 'kenburns 5.5s ease-out forwards' } : undefined}
          >
            <Image
              src={slide.src}
              alt={slide.caption}
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-8 pb-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-14">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#1cb956] text-white text-[11px] font-semibold tracking-[0.1em] uppercase px-7 py-4 transition-colors duration-200 w-full sm:w-auto"
          >
          ...
          <Link
            href="/destinations"
            className="inline-flex items-center justify-center gap-2 border border-white/25 text-white hover:border-white/60 hover:bg-white/5 text-[11px] font-medium tracking-[0.1em] uppercase px-7 py-4 transition-all duration-200 w-full sm:w-auto"
          >
